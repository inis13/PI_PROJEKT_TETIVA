...
namespace Projekt_PI_Tetiva {
    ...
    public partial class pi2013tetivadbDataSet : global::System.Data.DataSet {
        ...
        public partial class NarudzbeniceDataTable : global::System.Data.TypedTableBase<NarudzbeniceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public NarudzbeniceRow AddNarudzbeniceRow(int RB, string Naziv, string Jedinica_mjere, int Kolicina, double Cijena, string Partner) {
...
SELECT RB, Sifra, Naziv, Jedinicna_mjera, Partner, Jedinicna_cijena, Kolicina, Datum FROM Otpremnice WHERE (Sifra = @Sifra)";
    ...
    public partial class NarudzbeniceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Narudzbenice] WHERE (([RB] = @Original_RB) AND ([Sifra] = @Original_Sifra) AND ([Naziv] = @Original_Naziv) AND ([Jedinica_mjere] = @Original_Jedinica_mjere) AND ([Kolicina] = @Original_Kolicina) AND ([Cijena] = @Original_Cijena) AND ([Partner] = @Original_Partner))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_RB", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "RB", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Sifra", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Sifra", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Naziv", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Naziv", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Narudzbenice] ([RB], [Naziv], [Jedinica_mjere], [Kolicina], [Cijena], [Partner]) VALUES (@RB, @Naziv, @Jedinica_mjere, @Kolicina, @Cijena, @Partner);
SELECT RB, Sifra, Naziv, Jedinica_mjere, Kolicina, Cijena, Partner FROM Narudzbenice WHERE (Sifra = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@RB", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "RB", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Naziv", global::System.Data.SqlDbType.Char, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Naziv", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
...
SELECT RB, Sifra, Naziv, Jedinica_mjere, Kolicina, Cijena, Partner FROM Narudzbenice WHERE (Sifra = @Sifra)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT RB, Sifra, Naziv, Jedinica_mjere, Kolicina, Cijena, Partner FROM dbo.Narud" +
                "zbenice";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            ...
            this._commandCollection[2].CommandText = "SELECT RB, Sifra, Naziv, Jedinica_mjere, Kolicina, Cijena, Partner FROM dbo.Narud" +
                "zbenice WHERE Sifra= @sifra";
            ...
            this._commandCollection[3].CommandText = "UPDATE Narudzbenice\r\nSET Odobreno=1\r\nWHERE Sifra=@Sifra";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Sifra", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Sifra", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(pi2013tetivadbDataSet.NarudzbeniceDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual pi2013tetivadbDataSet.NarudzbeniceDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            pi2013tetivadbDataSet.NarudzbeniceDataTable dataTable = new pi2013tetivadbDataSet.NarudzbeniceDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int Report(pi2013tetivadbDataSet.NarudzbeniceDataTable dataTable, int sifra) {
        ...
        public virtual pi2013tetivadbDataSet.NarudzbeniceDataTable Report1(int sifra) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(sifra));
            pi2013tetivadbDataSet.NarudzbeniceDataTable dataTable = new pi2013tetivadbDataSet.NarudzbeniceDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(pi2013tetivadbDataSet.NarudzbeniceDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_RB, int Original_Sifra, string Original_Naziv, string Original_Jedinica_mjere, int Original_Kolicina, double Original_Cijena, string Original_Partner) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_RB));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_Sifra));
            if ((Original_Naziv == null)) {
                throw new global::System.ArgumentNullException("Original_Naziv");
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int RB, string Naziv, string Jedinica_mjere, int Kolicina, double Cijena, string Partner) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(RB));
            if ((Naziv == null)) {
                throw new global::System.ArgumentNullException("Naziv");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int RB, string Naziv, string Jedinica_mjere, int Kolicina, double Cijena, string Partner, int Original_RB, int Original_Sifra, string Original_Naziv, string Original_Jedinica_mjere, int Original_Kolicina, double Original_Cijena, string Original_Partner, int Sifra) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(RB));
            if ((Naziv == null)) {
                throw new global::System.ArgumentNullException("Naziv");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_RB));
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Original_Kolicina));
            this.Adapter.UpdateCommand.Parameters[11].Value = ((double)(Original_Cijena));
            if ((Original_Partner == null)) {
                throw new global::System.ArgumentNullException("Original_Partner");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_Partner));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int RB, string Naziv, string Jedinica_mjere, int Kolicina, double Cijena, string Partner, int Original_RB, int Original_Sifra, string Original_Naziv, string Original_Jedinica_mjere, int Original_Kolicina, double Original_Cijena, string Original_Partner) {
            return this.Update(RB, Naziv, Jedinica_mjere, Kolicina, Cijena, Partner, Original_RB, Original_Sifra, Original_Naziv, Original_Jedinica_mjere, Original_Kolicina, Original_Cijena, Original_Partner, Original_Sifra);
        }
        ...
        public virtual int BrisanjeNarudzbenice(int idSifra) {
